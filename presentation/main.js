...
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.State = Elm.SliceShow.State || {};
Elm.SliceShow.State.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.State = _elm.SliceShow.State || {};
   if (_elm.SliceShow.State.values) return _elm.SliceShow.State.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var activate = function (state) {
      var _p0 = state;
      switch (_p0.ctor)
      {case "Hidden": return Active;
         case "Active": return Visited;
         case "Inactive": return Inactive;
         default: return Visited;}
   };
   return _elm.SliceShow.State.values = {_op: _op,activate: activate,Inactive: Inactive,Hidden: Hidden,Active: Active,Visited: Visited};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.ContentData = Elm.SliceShow.ContentData || {};
Elm.SliceShow.ContentData.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.ContentData = _elm.SliceShow.ContentData || {};
   if (_elm.SliceShow.ContentData.values) return _elm.SliceShow.ContentData.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow$State = Elm.SliceShow.State.make(_elm);
   var _op = {};
   var visited = function (state) {    var _p0 = state;if (_p0.ctor === "Active") {    return $SliceShow$State.Visited;} else {    return state;}};
   var hasHidden = function (elements) {
      hasHidden: while (true) {
         var _p1 = elements;
         if (_p1.ctor === "[]") {
               return false;
            } else {
               switch (_p1._0.ctor)
               {case "Item": var _p2 = _p1._0._0;
                    if (_p2.ctor === "Hidden") {
                          return true;
                       } else {
                          var _v3 = _p1._1;
                  ...
                  default: var _p4 = _p1._0._0;
                    if (_p4.ctor === "Hidden") {
                          return true;
                       } else {
                          return hasHidden(_p1._0._2) || hasHidden(_p1._1);
                       }}
            }
      }
   };
   var state = function (element) {
      var _p5 = element;
      switch (_p5.ctor)
      {case "Container": return _p5._0;
         case "Item": return _p5._0;
         default: return _p5._0;}
   };
   var Custom = F2(function (a,b) {    return {ctor: "Custom",_0: a,_1: b};});
   var Item = F2(function (a,b) {    return {ctor: "Item",_0: a,_1: b};});
   var Container = F3(function (a,b,c) {    return {ctor: "Container",_0: a,_1: b,_2: c};});
   var showNext = function (elements) {
      var _p6 = elements;
      if (_p6.ctor === "[]") {
            return _U.list([]);
         } else {
            switch (_p6._0.ctor)
            {case "Item": var _p10 = _p6._0._0;
                 var _p9 = _p6._1;
                 var _p8 = _p6._0._1;
                 var _p7 = _p10;
                 if (_p7.ctor === "Hidden") {
                       return A2($List._op["::"],A2(Item,$SliceShow$State.Active,_p8),_p9);
                    } else {
                       return A2($List._op["::"],A2(Item,visited(_p10),_p8),showNext(_p9));
                    }
               case "Custom": var _p14 = _p6._0._0;
                 var _p13 = _p6._1;
                 var _p12 = _p6._0._1;
                 var _p11 = _p14;
                 if (_p11.ctor === "Hidden") {
                       return A2($List._op["::"],A2(Custom,$SliceShow$State.Active,_p12),_p13);
                    } else {
                       return A2($List._op["::"],A2(Custom,visited(_p14),_p12),showNext(_p13));
                    }
               default: var _p19 = _p6._0._0;
                 var _p18 = _p6._1;
                 var _p17 = _p6._0._1;
                 var _p16 = _p6._0._2;
                 var _p15 = _p19;
                 if (_p15.ctor === "Hidden") {
                       return A2($List._op["::"],A3(Container,$SliceShow$State.Active,_p17,_p16),_p18);
                    } else {
                       return hasHidden(_p16) ? A2($List._op["::"],A3(Container,visited(_p19),_p17,showNext(_p16)),_p18) : A2($List._op["::"],
                       A3(Container,visited(_p19),_p17,_p16),
                       showNext(_p18));
                    }}
         }
   };
   var update = F3(function (updateCustom,action,elements) {
      var _p20 = elements;
      if (_p20.ctor === "[]") {
            return {ctor: "_Tuple2",_0: _U.list([]),_1: _U.list([])};
         } else {
            switch (_p20._0.ctor)
            {case "Custom": var _p26 = _p20._0._0;
                 var _p25 = _p20._1;
                 var _p24 = _p20._0._1;
                 if (!_U.eq(_p26,$SliceShow$State.Hidden)) {
                       var _p21 = A3(update,updateCustom,action,_p25);
                       var updatedSiblings = _p21._0;
                       var siblingsEffects = _p21._1;
                       var _p22 = A2(updateCustom,action,_p24);
                       var updatedSelf = _p22._0;
                       var selfEffect = _p22._1;
                       return _U.eq(selfEffect,$Effects.none) ? {ctor: "_Tuple2"
                                                                ,_0: A2($List._op["::"],A2(Custom,_p26,updatedSelf),updatedSiblings)
                                                                ,_1: siblingsEffects} : {ctor: "_Tuple2"
                                                                                        ,_0: A2($List._op["::"],A2(Custom,_p26,updatedSelf),updatedSiblings)
                                                                                        ,_1: A2($List._op["::"],selfEffect,siblingsEffects)};
                    } else {
                       var _p23 = A3(update,updateCustom,action,_p25);
                       var updatedSiblings = _p23._0;
                       var siblingsEffects = _p23._1;
                       return {ctor: "_Tuple2",_0: A2($List._op["::"],A2(Custom,_p26,_p24),updatedSiblings),_1: siblingsEffects};
                    }
               case "Container": var _p27 = A3(update,updateCustom,action,_p20._1);
                 var updatedSiblings = _p27._0;
                 var siblingsEffects = _p27._1;
                 var _p28 = A3(update,updateCustom,action,_p20._0._2);
                 var updatedChildren = _p28._0;
                 var childrenEffects = _p28._1;
                 return {ctor: "_Tuple2"
                        ,_0: A2($List._op["::"],A3(Container,_p20._0._0,_p20._0._1,updatedChildren),updatedSiblings)
                        ,_1: A2($Basics._op["++"],childrenEffects,siblingsEffects)};
               default: var _p29 = A3(update,updateCustom,action,_p20._1);
                 var updatedSiblings = _p29._0;
                 var siblingsEffects = _p29._1;
                 return {ctor: "_Tuple2",_0: A2($List._op["::"],A2(Item,_p20._0._0,_p20._0._1),updatedSiblings),_1: siblingsEffects};}
         }
   });
   return _elm.SliceShow.ContentData.values = {_op: _op
                                              ,state: state
                                              ,update: update
                                              ,hasHidden: hasHidden
                                              ,showNext: showNext
...
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.SlideData = Elm.SliceShow.SlideData || {};
Elm.SliceShow.SlideData.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.SlideData = _elm.SliceShow.SlideData || {};
   if (_elm.SliceShow.SlideData.values) return _elm.SliceShow.SlideData.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow$ContentData = Elm.SliceShow.ContentData.make(_elm),
   $SliceShow$State = Elm.SliceShow.State.make(_elm);
   var _op = {};
   var showNextElement = function (slide) {    return _U.update(slide,{elements: $SliceShow$ContentData.showNext(slide.elements)});};
   var hasHiddenElements = function (_p0) {    var _p1 = _p0;return $SliceShow$ContentData.hasHidden(_p1.elements);};
   var updateCustomElement = F3(function (updateCustom,customAction,slide) {
      var _p2 = A3($SliceShow$ContentData.update,updateCustom,customAction,slide.elements);
      var newElements = _p2._0;
      var effects = _p2._1;
      return {ctor: "_Tuple2",_0: _U.update(slide,{elements: newElements}),_1: $Effects.batch(effects)};
   });
   var SlideData = F3(function (a,b,c) {    return {state: a,elements: b,dimensions: c};});
   return _elm.SliceShow.SlideData.values = {_op: _op
...
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Model = Elm.SliceShow.Model || {};
Elm.SliceShow.Model.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Model = _elm.SliceShow.Model || {};
   if (_elm.SliceShow.Model.values) return _elm.SliceShow.Model.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow$SlideData = Elm.SliceShow.SlideData.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var init = function (slides) {    return {currentSlide: $Maybe.Nothing,slides: slides,dimensions: {ctor: "_Tuple2",_0: 0,_1: 0}};};
   var resize = F2(function (dimensions,model) {    return _U.update(model,{dimensions: dimensions});});
   var open = F2(function (hash,model) {
      var _p0 = $String.toInt(A2($String.dropLeft,1,hash));
      if (_p0.ctor === "Ok") {
            var _p1 = _p0._0;
            return _U.cmp(_p1,0) > 0 && _U.cmp(_p1,$List.length(model.slides)) < 1 ? _U.update(model,{currentSlide: $Maybe.Just(_p1 - 1)}) : _U.update(model,
            {currentSlide: $Maybe.Nothing});
         } else {
            return _U.update(model,{currentSlide: $Maybe.Nothing});
         }
   });
   var replaceCurrent = F2(function (slide,model) {
      var replaceWith = F3(function (atIndex,currentIndex,currentSlide) {    return _U.eq(atIndex,currentIndex) ? slide : currentSlide;});
      var _p2 = model.currentSlide;
      if (_p2.ctor === "Just") {
            return _U.update(model,{slides: A2($List.indexedMap,replaceWith(_p2._0),model.slides)});
         } else {
            return model;
         }
   });
   var currentSlide = function (_p3) {
      var _p4 = _p3;
      return A2($Maybe.andThen,A2($Maybe.map,A2($Basics.flip,$List.drop,_p4.slides),_p4.currentSlide),$List.head);
   };
   var update = F3(function (updateCustom,customAction,model) {
      var _p5 = currentSlide(model);
      if (_p5.ctor === "Just") {
            var _p6 = A3($SliceShow$SlideData.updateCustomElement,updateCustom,customAction,_p5._0);
            var newSlide = _p6._0;
            var effects = _p6._1;
            return {ctor: "_Tuple2",_0: A2(replaceCurrent,newSlide,model),_1: effects};
         } else {
            return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         }
   });
   var hash = function (model) {
      var _p7 = model.currentSlide;
      if (_p7.ctor === "Nothing") {
            return "#";
         } else {
            return A2($Basics._op["++"],"#",$Basics.toString(_p7._0 + 1));
         }
   };
   var offset = F2(function (offset,model) {
      var _p8 = model.currentSlide;
      if (_p8.ctor === "Nothing") {
            return _U.update(model,{currentSlide: $Maybe.Just(0)});
         } else {
            return _U.update(model,{currentSlide: $Maybe.Just(A2($Basics.min,$List.length(model.slides) - 1,A2($Basics.max,0,_p8._0 + offset)))});
         }
   });
   var next = function (model) {
      var _p9 = currentSlide(model);
      if (_p9.ctor === "Just") {
            var _p10 = _p9._0;
            return $SliceShow$SlideData.hasHiddenElements(_p10) ? A2(replaceCurrent,$SliceShow$SlideData.showNextElement(_p10),model) : A2(offset,1,model);
         } else {
            return A2(offset,1,model);
         }
   };
   var prev = offset(-1);
   var Model = F3(function (a,b,c) {    return {currentSlide: a,slides: b,dimensions: c};});
   return _elm.SliceShow.Model.values = {_op: _op
                                        ,init: init
                                        ,next: next
                                        ,prev: prev
                                        ,hash: hash
...
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Actions = Elm.SliceShow.Actions || {};
Elm.SliceShow.Actions.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Actions = _elm.SliceShow.Actions || {};
   if (_elm.SliceShow.Actions.values) return _elm.SliceShow.Actions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var Prev = {ctor: "Prev"};
   var Next = {ctor: "Next"};
   return _elm.SliceShow.Actions.values = {_op: _op,Next: Next,Prev: Prev,Goto: Goto,Open: Open,Resize: Resize,Index: Index,Noop: Noop,Custom: Custom};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Update = Elm.SliceShow.Update || {};
Elm.SliceShow.Update.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Update = _elm.SliceShow.Update || {};
   if (_elm.SliceShow.Update.values) return _elm.SliceShow.Update.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow$Actions = Elm.SliceShow.Actions.make(_elm),
   $SliceShow$Model = Elm.SliceShow.Model.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var withHashChange = function (model) {
      return {ctor: "_Tuple2"
             ,_0: model
             ,_1: $Effects.task(A2($Task.map,$Basics.always($SliceShow$Actions.Noop),$History.setPath($SliceShow$Model.hash(model))))};
   };
   var update = F3(function (updateCustom,action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Next": return withHashChange($SliceShow$Model.next(model));
         case "Prev": return withHashChange($SliceShow$Model.prev(model));
         case "Index": return withHashChange(_U.update(model,{currentSlide: $Maybe.Nothing}));
         case "Goto": return withHashChange(_U.update(model,{currentSlide: $Maybe.Just(_p0._0)}));
         case "Open": return {ctor: "_Tuple2",_0: A2($SliceShow$Model.open,_p0._0,model),_1: $Effects.none};
         case "Resize": return {ctor: "_Tuple2",_0: _U.update(model,{dimensions: _p0._0}),_1: $Effects.none};
         case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         default: var _p1 = A3($SliceShow$Model.update,updateCustom,_p0._0,model);
           var newModel = _p1._0;
           var effects = _p1._1;
           return {ctor: "_Tuple2",_0: newModel,_1: A2($Effects.map,$SliceShow$Actions.Custom,effects)};}
   });
   return _elm.SliceShow.Update.values = {_op: _op,update: update};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.View = Elm.SliceShow.View || {};
Elm.SliceShow.View.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.View = _elm.SliceShow.View || {};
   if (_elm.SliceShow.View.values) return _elm.SliceShow.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $SliceShow$State = Elm.SliceShow.State.make(_elm);
   var _op = {};
   var viewElements = F3(function (renderCustom,customAddress,elements) {
      return A2($List.map,
      A2(viewElement,renderCustom,customAddress),
      A2($List.filter,function (c) {    return !_U.eq($SliceShow$ContentData.state(c),$SliceShow$State.Hidden);},elements));
   });
   var viewElement = F3(function (renderCustom,customAddress,content) {
      var _p0 = content;
      switch (_p0.ctor)
      {case "Container": return _p0._1(A3(viewElements,renderCustom,customAddress,_p0._2));
         case "Item": return _p0._1;
         default: return A2(renderCustom,customAddress,_p0._1);}
   });
   _op["=>"] = F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};});
   var toPx = function (x) {    return A2($Basics._op["++"],$Basics.toString(x),"px");};
   var fit = F2(function (_p2,_p1) {
      var _p3 = _p2;
      var _p8 = _p3._0;
      var _p7 = _p3._1;
      var _p4 = _p1;
      var _p6 = _p4._0;
      var _p5 = _p4._1;
      return _U.cmp(_p8 * _p5,_p6 * _p7) < 0 ? $Basics.toFloat(_p8) / $Basics.toFloat(_p6) : $Basics.toFloat(_p7) / $Basics.toFloat(_p5);
   });
   var viewSlide = F4(function (renderCustom,address,dimensions,slide) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],
                                              "transform",
                                              A2($Basics._op["++"],"scale(",A2($Basics._op["++"],$Basics.toString(A2(fit,dimensions,slide.dimensions)),")")))
                                              ,A2(_op["=>"],"width",toPx($Basics.fst(slide.dimensions)))
                                              ,A2(_op["=>"],"height",toPx($Basics.snd(slide.dimensions)))
                                              ,A2(_op["=>"],"position","absolute")
                                              ,A2(_op["=>"],"left","50%")
                                              ,A2(_op["=>"],"top","50%")
                                              ,A2(_op["=>"],"margin-left",toPx($Basics.fst(slide.dimensions) / -2 | 0))
                                              ,A2(_op["=>"],"margin-top",toPx($Basics.snd(slide.dimensions) / -2 | 0))
                                              ,A2(_op["=>"],"background","#fff")
                                              ,A2(_op["=>"],"box-sizing","border-box")
                                              ,A2(_op["=>"],"text-align","left")]))]),
      A3(viewElements,renderCustom,A2($Signal.forwardTo,address,$SliceShow$Actions.Custom),slide.elements));
   });
   var viewSlideItem = F4(function (renderCustom,address,index,slide) {
      return A2($Html.a,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"position","relative")
                                              ,A2(_op["=>"],"width","240px")
                                              ,A2(_op["=>"],"height","150px")
                                              ,A2(_op["=>"],"display","inline-block")
                                              ,A2(_op["=>"],"margin","20px 0 0 20px")]))
              ,$Html$Attributes.href(A2($Basics._op["++"],"#",$Basics.toString(index + 1)))]),
      _U.list([A4(viewSlide,renderCustom,address,{ctor: "_Tuple2",_0: 240,_1: 150},slide)]));
   });
   var viewContainer = F3(function (renderCustom,address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.style(_U.list([A2(_op["=>"],"text-align","center")]))]),
      A2($List.indexedMap,A2(viewSlideItem,renderCustom,address),model.slides));
   });
   var view = F3(function (renderCustom,address,model) {
      var _p9 = $SliceShow$Model.currentSlide(model);
      if (_p9.ctor === "Nothing") {
            return A3(viewContainer,renderCustom,address,model);
         } else {
            return A4(viewSlide,renderCustom,address,model.dimensions,_p9._0);
         }
   });
   return _elm.SliceShow.View.values = {_op: _op,view: view};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Content = Elm.SliceShow.Content || {};
Elm.SliceShow.Content.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Content = _elm.SliceShow.Content || {};
   if (_elm.SliceShow.Content.values) return _elm.SliceShow.Content.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var hide = function (content) {
      var _p0 = content;
      switch (_p0.ctor)
      {case "Container": return A3($SliceShow$ContentData.Container,$SliceShow$State.Hidden,_p0._1,_p0._2);
         case "Item": return A2($SliceShow$ContentData.Item,$SliceShow$State.Hidden,_p0._1);
         default: return A2($SliceShow$ContentData.Custom,$SliceShow$State.Hidden,_p0._1);}
   };
   var container = $SliceShow$ContentData.Container($SliceShow$State.Inactive);
   var custom = $SliceShow$ContentData.Custom($SliceShow$State.Inactive);
   var item = $SliceShow$ContentData.Item($SliceShow$State.Inactive);
   return _elm.SliceShow.Content.values = {_op: _op,container: container,item: item,custom: custom,hide: hide};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Protected = Elm.SliceShow.Protected || {};
Elm.SliceShow.Protected.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Protected = _elm.SliceShow.Protected || {};
   if (_elm.SliceShow.Protected.values) return _elm.SliceShow.Protected.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var unlock = function (_p0) {    var _p1 = _p0;return _p1._0;};
   var Protected = function (a) {    return {ctor: "Protected",_0: a};};
   var lock = Protected;
   return _elm.SliceShow.Protected.values = {_op: _op,unlock: unlock,lock: lock};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.Slide = Elm.SliceShow.Slide || {};
Elm.SliceShow.Slide.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   _elm.SliceShow.Slide = _elm.SliceShow.Slide || {};
   if (_elm.SliceShow.Slide.values) return _elm.SliceShow.Slide.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow$Content = Elm.SliceShow.Content.make(_elm),
   $SliceShow$Protected = Elm.SliceShow.Protected.make(_elm),
   $SliceShow$SlideData = Elm.SliceShow.SlideData.make(_elm),
   $SliceShow$State = Elm.SliceShow.State.make(_elm);
   var _op = {};
   var slide = function (elements) {
      return $SliceShow$Protected.lock({elements: elements,state: $SliceShow$State.Hidden,dimensions: {ctor: "_Tuple2",_0: 1024,_1: 640}});
   };
   return _elm.SliceShow.Slide.values = {_op: _op,slide: slide};
};
Elm.SliceShow = Elm.SliceShow || {};
Elm.SliceShow.make = function (_elm) {
   "use strict";
   _elm.SliceShow = _elm.SliceShow || {};
   if (_elm.SliceShow.values) return _elm.SliceShow.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $SliceShow$Model = Elm.SliceShow.Model.make(_elm),
   $SliceShow$Protected = Elm.SliceShow.Protected.make(_elm),
   $SliceShow$Slide = Elm.SliceShow.Slide.make(_elm),
   $SliceShow$Update = Elm.SliceShow.Update.make(_elm),
   $SliceShow$View = Elm.SliceShow.View.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm),
   $Window = Elm.Window.make(_elm);
   var _op = {};
   var show = function (config) {
      var _p0 = $SliceShow$Protected.unlock(config);
      var model = _p0.model;
      var update = _p0.update;
      var view = _p0.view;
      var inputs = _p0.inputs;
      var onKeyDown = F2(function (keyCode,action) {
         return A2($Signal.map,$Basics.always(action),A3($Signal.filter,$Basics.identity,false,$Keyboard.isDown(keyCode)));
      });
      var app = $StartApp.start({init: {ctor: "_Tuple2",_0: model,_1: $Effects.none}
                                ,update: $SliceShow$Update.update(update)
                                ,view: $SliceShow$View.view(view)
                                ,inputs: A2($Basics._op["++"],
                                A2($List.map,$Signal.map($SliceShow$Actions.Custom),inputs),
                                _U.list([A2(onKeyDown,37,$SliceShow$Actions.Prev)
                                        ,A2(onKeyDown,39,$SliceShow$Actions.Next)
                                        ,A2(onKeyDown,27,$SliceShow$Actions.Index)
                                        ,A2($Signal.map,$SliceShow$Actions.Open,$History.hash)
                                        ,A2($Signal.map,$SliceShow$Actions.Resize,$Window.dimensions)]))});
      return {html: app.html,tasks: app.tasks};
   };
   var setInputs = F2(function (inputs,config) {
      var unlocked = $SliceShow$Protected.unlock(config);
      return $SliceShow$Protected.lock(_U.update(unlocked,{inputs: inputs}));
   });
   var setUpdate = F2(function (update,config) {
      var unlocked = $SliceShow$Protected.unlock(config);
      return $SliceShow$Protected.lock(_U.update(unlocked,{update: update}));
   });
   var setView = F2(function (view,config) {
      var unlocked = $SliceShow$Protected.unlock(config);
      return $SliceShow$Protected.lock(_U.update(unlocked,{view: view}));
   });
   var setHash = F2(function (hash,config) {
      var unlocked = $SliceShow$Protected.unlock(config);
      return $SliceShow$Protected.lock(_U.update(unlocked,{model: A2($SliceShow$Model.open,hash,unlocked.model)}));
   });
   var setDimensions = F2(function (dimensions,config) {
      var unlocked = $SliceShow$Protected.unlock(config);
      return $SliceShow$Protected.lock(_U.update(unlocked,{model: A2($SliceShow$Model.resize,dimensions,unlocked.model)}));
   });
   var init = function (slides) {
      return $SliceShow$Protected.lock({model: $SliceShow$Model.init(A2($List.map,$SliceShow$Protected.unlock,slides))
                                       ,view: F2(function (_p2,_p1) {    return $Html.text("");})
                                       ,update: F2(function (_p3,a) {    return {ctor: "_Tuple2",_0: a,_1: $Effects.none};})
                                       ,inputs: _U.list([])});
   };
   var PrivateConfig = F4(function (a,b,c,d) {    return {model: a,update: b,view: c,inputs: d};});
   var SliceShow = F2(function (a,b) {    return {html: a,tasks: b};});
   return _elm.SliceShow.values = {_op: _op
                                  ,init: init
                                  ,show: show
...
Elm.Slides.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var paddedSlide = function (content) {
      return $SliceShow$Slide.slide(_U.list([A2($SliceShow$Content.container,
      $Html.div(_U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "padding",_1: "50px 100px"}]))])),
      content)]));
   };
   var code = F2(function (lang,str) {
      return $SliceShow$Content.item($Markdown.toHtml(A2($Basics._op["++"],
      "```",
      A2($Basics._op["++"],lang,A2($Basics._op["++"],"\n",A2($Basics._op["++"],str,"\n```"))))));
   });
   var bulletLink = F2(function (str,url) {
      return $SliceShow$Content.item(A2($Html.li,_U.list([]),_U.list([A2($Html.a,_U.list([$Html$Attributes.href(url)]),_U.list([$Html.text(str)]))])));
   });
   var bullet = function (str) {    return $SliceShow$Content.item(A2($Html.li,_U.list([]),_U.list([$Html.text(str)])));};
   var subBullets = $SliceShow$Content.container($Html.li(_U.list([])));
   var bullets = $SliceShow$Content.container($Html.ul(_U.list([])));
   var column = function (attr) {    return $SliceShow$Content.container($Html.div(attr));};
   var centeredText = function (str) {
      return $SliceShow$Content.item(A2($Html.div,
      ...
      _U.list([A2($Html.div,_U.list([]),_U.list([$Html.text(str)]))])));
   };
   var slides = A2($List.map,
   paddedSlide,
   _U.list([_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Functional Reactive Programming for the Web using Elm")])))
                    ,$SliceShow$Content.item(A2($Html.p,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-bottom",_1: "10px"}]))]),
                    _U.list([$Html.text("Magnus Rundberget")])))
                    ,$SliceShow$Content.item(A2($Html.div,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}
                                                            ,{ctor: "_Tuple2",_0: "height",_1: "20px"}
                                                            ,{ctor: "_Tuple2",_0: "align-items",_1: "center"}]))]),
                    _U.list([A2($Html.img,_U.list([$Html$Attributes.src("assets/twitter.png")]),_U.list([]))
                            ,A2($Html.span,
                            _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-size",_1: "15px"}]))]),
                            _U.list([$Html.text("@mrundberget")]))])))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Agenda")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("About Elm"))
                                     ,$SliceShow$Content.hide(bullet("Functional Reactive Programming and Signals"))
                                     ,$SliceShow$Content.hide(bullet("Diving into The Elm Architecture (Live coding)"))
                                     ,$SliceShow$Content.hide(bullet("The Elm Platform and ecosystem"))
                                     ,$SliceShow$Content.hide(bullet("Summary"))]))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("About me")])))
                    ,$SliceShow$Content.item(A2($Html.img,
                    _U.list([$Html$Attributes.src("assets/magnus.png")
                            ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "position",_1: "absolute"}
                                                            ,{ctor: "_Tuple2",_0: "left",_1: "50%"}
                                                            ,{ctor: "_Tuple2",_0: "margin-left",_1: "-250px"}]))]),
                    _U.list([])))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("What is Elm ?")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("Created by Evan Czaplicki (2012)"))
                                     ,$SliceShow$Content.hide(bullet("Functional and statically typed"))
                                     ,$SliceShow$Content.hide(bullet("ML family syntax"))
                                     ,$SliceShow$Content.hide(bullet("Compiles to JavaScript (ES5)"))]))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Goals ?")])))
                    ,$SliceShow$Content.item(A2($Html.p,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-style",_1: "italic"}]))]),
                    _U.list([$Html.text("Make Functional Programming (with types) for the Web mainstream")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("Easy to learn and become productive, yet powerful"))
                                     ,$SliceShow$Content.hide(bullet("Reliable - No runtime exceptions !"))
                                     ,$SliceShow$Content.hide(bullet("The compiler should be a helpful assistant"))
                                     ,$SliceShow$Content.hide(bullet("Manage complexity by embracing best of FP properties"))]))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.p,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-style",_1: "italic"}
                                                            ,{ctor: "_Tuple2",_0: "margin-top",_1: "100px"}
                                                            ,{ctor: "_Tuple2",_0: "color",_1: "blue"}]))]),
                    _U.list([$Html.text("Do check out: \"Let\'s be mainstream, User-focused design in Elm\" (Evan Czaplicki)")]))))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Functional Reactive Programming")])))
                    ,$SliceShow$Content.item(A2($Html.p,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "font-style",_1: "italic"}]))]),
                    _U.list([$Markdown.toHtml("a programming paradigm for reactive programming (**asynchronous dataflow** programming) using the building blocks of functional programming (e.g. map, reduce, filter). FRP has been used for programming graphical user interfaces (GUIs), robotics, and music, aiming to simplify these problems by **explicitly modeling time**")])))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("FRP example")])))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.img,
                    _U.list([$Html$Attributes.src("assets/frp1.png"),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-left",_1: "-100px"}]))]),
                    _U.list([]))))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.img,
                    _U.list([$Html$Attributes.src("assets/frp2.png"),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-left",_1: "-100px"}]))]),
                    _U.list([]))))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.img,
                    _U.list([$Html$Attributes.src("assets/frp3.png"),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-left",_1: "-100px"}]))]),
                    _U.list([]))))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.img,
                    _U.list([$Html$Attributes.src("assets/frp4.png"),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin-left",_1: "-100px"}]))]),
                    _U.list([]))))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Signals in Elm")])))
                    ,A2(column,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}]))]),
                    _U.list([A2(column,
                            _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "80%"}]))]),
                            _U.list([bullets(_U.list([$SliceShow$Content.hide(bullet("Signal is a value that changes over time"))
                                                     ,$SliceShow$Content.hide(bullet("Known/computed at compile time"))
                                                     ,$SliceShow$Content.hide(bullet("Forms a static Signal graph"))
                                                     ,$SliceShow$Content.hide(bullet("Not allowed to change at runtime"))]))]))
                            ,A2(column,
                            _U.list([]),
                            _U.list([$SliceShow$Content.item(A2($Html.img,
                            _U.list([$Html$Attributes.src("assets/signalgraph.png")
                                    ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "height",_1: "450px"}]))]),
                            _U.list([])))]))]))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("The Elm Architecture")])))
                    ,$SliceShow$Content.item(A2($Html.img,_U.list([$Html$Attributes.src("assets/tea.png")]),_U.list([])))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Live Coding")])))
                    ,$SliceShow$Content.item(A2($Html.div,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}
                                                            ,{ctor: "_Tuple2",_0: "justify-content",_1: "center"}]))]),
                    _U.list([A2($Html.img,_U.list([$Html$Attributes.src("assets/demo.png")]),_U.list([]))])))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("The Elm platform and ecosystem")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("elm-make"))
                                     ,$SliceShow$Content.hide(bullet("elm-repl"))
                                     ,$SliceShow$Content.hide(bullet("elm-reactor"))
                                     ,$SliceShow$Content.hide(bullet("elm-package"))
                                     ,$SliceShow$Content.hide(subBullets(_U.list([bullet("Community")
                                                                                 ,bullets(_U.list([bullet("elm-format")
           ...
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("JavaScript interop")])))
                    ,A2(column,
                    _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "flex"}]))]),
                    _U.list([A2(column,
                            _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "40%"}]))]),
                            _U.list([$SliceShow$Content.item(A2($Html.img,_U.list([$Html$Attributes.src("assets/ports.png")]),_U.list([])))]))
                            ,A2(column,
                            _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "60%"}]))]),
                            _U.list([bullets(_U.list([$SliceShow$Content.hide(bullet("Customs and border protection"))
                                                     ,$SliceShow$Content.hide(bullet("Conversion of JS to Elm types and vice versa"))
                                                     ,$SliceShow$Content.hide(bullet("Safe guard against runtime exceptions in your Elm app"))]))]))]))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Future of Elm")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("Next version"))
                                     ,$SliceShow$Content.hide(bullet("UI Components"))
                                     ,$SliceShow$Content.hide(bullet("Ready for production use ?"))]))])
           ,_U.list([$SliceShow$Content.item(A2($Html.h1,_U.list([]),_U.list([$Html.text("Summary")])))
                    ,bullets(_U.list([$SliceShow$Content.hide(bullet("Elm is an exciting and friendly language"))
                                     ,$SliceShow$Content.hide(bullet("Elm makes Functional Reactive Programming surprisingly approachable"))
                                     ,$SliceShow$Content.hide(bullet("The Elm Architecture is a promising solution for composing scalable architectures"))]))
                    ,$SliceShow$Content.hide($SliceShow$Content.item(A2($Html.p,
                    _U.list([]),
                    _U.list([$Html.text("It’s fun and well worth a closer look !")]))))])]));
   var inputs = _U.list([$Time.fps(1)]);
   var view = F2(function (_p0,time) {
      ...
      A2($Basics._op["++"],$Basics.toString($Basics.round($Time.inSeconds(time)))," seconds")))]));
   });
   var update = F2(function (elapsed,time) {    return {ctor: "_Tuple2",_0: time + elapsed,_1: $Effects.none};});
   return _elm.Slides.values = {_op: _op,slides: slides,update: update,view: view,inputs: inputs};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $SliceShow = Elm.SliceShow.make(_elm),
   $Slides = Elm.Slides.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var locationHash = Elm.Native.Port.make(_elm).inbound("locationHash",
   "String",
   function (v) {
      return typeof v === "string" || typeof v === "object" && v instanceof String ? v : _U.badPort("a string",v);
   });
   var windowDimensions = Elm.Native.Port.make(_elm).inbound("windowDimensions",
   "( Int, Int )",
   function (v) {
   ...
   var sliceShow = $SliceShow.show(A2($SliceShow.setView,
   $Slides.view,
   A2($SliceShow.setUpdate,
   $Slides.update,
   A2($SliceShow.setInputs,$Slides.inputs,A2($SliceShow.setHash,locationHash,A2($SliceShow.setDimensions,windowDimensions,$SliceShow.init($Slides.slides)))))));
   var main = sliceShow.html;
   var tasks = Elm.Native.Task.make(_elm).performSignal("tasks",sliceShow.tasks);
   return _elm.Main.values = {_op: _op,sliceShow: sliceShow,main: main};
};
